...
\bibitem{Baz} \textsc{Hastie, T., Tibshirani, R., Friedman, J} The Elements of Statistical Learning. Data Mining, Inference, and Prediction, 2nd ed., Springer.

\bibitem{Baz}  \textsc{G. James, D. Witten, T. Hastie and R. Tibshirani}  An Introduction to Statistical Learning, with Application in R  (Springer, 2013).

\bibitem{Baz} \textsc{Diggle, P} 
Statistical Learning with Sparsity. The lasso and generalizations. Chapman and Hall.


\bibitem{Baz} \textsc{T. W. Anderson} An Introduction to Multivariate Statistical Analysis, John Wiley and Sons Inc; Edición: 3rd Edition .
...
\bibitem{Dan1} \textsc{Thomas W. Yee},
